      ...
      <ScrollView>
        <ImageBackground source={images.house1} resizeMode={'cover'} style={{ height: 300, }}>
          ...
          <View style={{ marginHorizontal: 25, marginTop: 120 }}>
            ...
            <Text style={{ fontWeight: '700', fontSize: 20, color: '#fff' }}>To live laxuray Life</Text>

          </View>
        </ImageBackground>
        <View style={{ flexDirection: 'row', backgroundColor: '#fff', marginHorizontal: 25, borderRadius: 5, elevation: 6, height: 50, marginTop: -25, alignItems: 'center' }}>
          <Image
        ...
        <View style={{ padding: 5 }}>
          <View style={{ backgroundColor: '#fff', borderRadius: 10, elevation: 6, marginHorizontal: 5, marginTop: 20, }}>
            <View style={{ padding: 10 }}>
              <Image source={images.house1} style={{ width: '98%', height: 100, marginRight: 20 }} />
              <View>
                <Text style={{ fontSize: 18, color: 'grey', marginTop: 0 }}>Description </Text>
                <View style={{ flexDirection: 'row', marginBottom: 10, justifyContent: 'space-between', alignItems: 'center', marginTop: 10 }}>
                  <Text style={{ color: '#000', marginBottom: 0 }}>House Name</Text>
